...
public class BowMcBomb extends Module {
    ...
    public BowMcBomb() { super("Bowkill", "Uno hitter w bows", Category.COMBAT, true, false, false); }
    ...
    public Setting <Integer> spoofs = this.register ( new Setting <> ( "Spoofs", 55, 1, 300 ) );
